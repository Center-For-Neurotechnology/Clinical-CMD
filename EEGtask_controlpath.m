...
% restore the path saved in the variable 'wel'
% - wel: list of path that has to be restored when closing EEGtask
% output:
% - welcome: list of path previous to EEGtask opening
