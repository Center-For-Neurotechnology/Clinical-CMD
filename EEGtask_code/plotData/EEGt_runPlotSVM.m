...
% 
% if isempty(specON) || isempty(specOFF); return; end
% 
% % EEGplotPSD(specON,specOFF,PSD.f,chanlocs,goodCH,fig_type)
% EEGPlotSpectraByWT_1(specON,specOFF,class,chanlocs,PSD.f)
...
EEGPlotSpectraByWT_1(specON,specOFF,class,chanlocs(goodCH),PSD.f)
