...
rejepochE=zeros(tmp.nbchan,tmp.trials); % electrode rejection array (size nb_elec x trials) also made of 0 and 1.
winrej=trial2eegplot(rejepoch,rejepochE,tmp.pnts,rejepochcol); % array defining windows which is compatible with 
