...
% - analysis: a number from 1 to 8 that refers to the analysis to perform
% Output: 
% - eegt structure updated

% Other functions: 
% deleteAnalyses: delete the analyses performed after a selected point
% readDat: Load the data saved in the .dat file
% readPSD_Dat: Load the PSD .dat file
% saveDat: Save data in a .dat format file
% savePSD_Dat: Save PSD data in a .dat format file
% -----------------------------------------------------------------------
...
switch analysis
    case 1
        ...
        eegt.tasks.(task).Trig_CH=EEG.Trig_CH;
        EEG=rmfield(EEG,'Trig_CH');
    ...
    case 6
        ...
        [EEG,parameters] = EEGtask_runLpFilt_WithConcat_v2(eegt,task,analyses_name);
        Bplot_Topo(mean(EEG.data,3),EEG.times,EEG.nbchan,EEG.badchannels,EEG.chanlocs)
...
% Save PSD data in .dat format files
