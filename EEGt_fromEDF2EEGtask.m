...
% - data: data vector [channels x samples]
% - subj: subject ID [char]
% - ses: session name [char]
% - task: task selected (name of the task) [char]
% - PN: Path folder where the file will be saved 
% - begin_blocks: vector that contains the begin of each block (sample) 
% - end_blocks: vector that contains the end of each block (sample) 
