...
% Last Modified by GUIDE v2.5 13-Aug-2025 16:15:08
...
[TextFromParams] = EEGgetTextFromParams(handles.eegt,task,analysis);
set(handles.textComm,'String',TextFromParams,'FontSize',8)
guidata(hObject, handles);
...
if isfield(handles,'eegt')
    ...
    textComm={['Running ''' analyses{analysis_v} ' ''analysis'];'';'Wait...'};
    set(handles.textComm,'String',textComm,'FontSize',8)
    ...
    set(handles.pushPlotSVM,'Enable','off')
    ...
    set(handles.listAnalyses,'Value',length(fieldnames(handles.eegt.tasks.(task).analyses)))
    ...
    set(handles.pushPlotSVM,'Enable','on')
...
eegt.PathName=[PathName filesep];
Create_EEGt(eegt)
...
EEGt_fromBrainAMP2EEGtask_MAonly
guidata(hObject, handles);
